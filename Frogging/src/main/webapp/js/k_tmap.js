	...
	function initTmap() {
		...
		marker_s = new Tmapv2.Marker(
				{
					position : new Tmapv2.LatLng(37.564991,126.9729412),
		...
		$
				.ajax({
					...
					success : function(response) {
						...
						console.log("총 거리: ", tDistance, "km /총 시간:", tTime+"분");
						...
						// 위도 경도 출력
						//console.log("위도: ", routeInfoObj.lng, "/경도: ", routeInfoObj.lat);
